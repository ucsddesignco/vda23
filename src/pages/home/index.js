...
function Showcase() {
	...
	return (
		<>
			<Navbar />
			<Landing
				description={'Design Co’s first ever Visual Design Apprenticeship is a 12-week long program where student designers worked on a variety of hands-on assignments focusing on visual, graphic, and brand design.'}
				button={
					<>
						<button
